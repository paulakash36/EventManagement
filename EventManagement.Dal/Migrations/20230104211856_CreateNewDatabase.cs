    ...
    public partial class CreateNewDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Kenchenhalli", "/images/ak.jpg", "Bangalore", "India", "paulak@gmail.com", "AK PAUL", "+91 1234567890", ".NET Developer", "560098" },
                    { 2, "Narayanpur", "/images/k.jpg", "Balurghat", "India", "paulk@gmail.com", "K PAUL", "+91 1235567890", "People Management", "733101" },
                    { 3, "Kenchenhalli", "/images/ab.jpg", "Bangalore", "India", "paulab@gmail.com", "AB PAUL", "+91 12333567890", "Trainer and Consultant", "560098" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Employee of Organisation", "Employee" },
                    { 2, "HR of Organisation", "HR" }
                });
